...
protected:	/*** Fix the error: change private to protected ***/
	double in_value;
	double out_value;
};
...
/*** Extension: lbs to kg conversion ***/
class p2k : public uConvert
{
	void read_unit() {
		cout << "Enter the number of pounds: ";
		cin >> in_value;
	}
	void convert() { out_value = in_value * 0.453592; }
	void print() { cout << "= " << out_value << " kg" << endl << endl; }
};
